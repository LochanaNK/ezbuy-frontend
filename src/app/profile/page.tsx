                    ...
                    {order.status === "Pending" && (
                      <div className="p-4 border-t flex justify-end gap-3">
                        <button
                          ...
                          className="inline-flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 font-medium shadow-sm hover:shadow-md active:scale-95"
                        >
                          <FiCreditCard size={18} />
                        </button>
                        <button
                          onClick={() => cancelOrder(order.id)}
                          className="inline-flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-lg hover:from-red-700 hover:to-red-800 transition-all duration-200 font-medium shadow-sm hover:shadow-md active:scale-95"
                        >
                          <FiTrash2 size={18} />
                        </button>
                      </div>
