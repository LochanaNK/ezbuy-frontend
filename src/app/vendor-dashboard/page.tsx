...
export default function VendorDashboard() {
  ...
  const { products, loading, addProduct, deleteProduct } = useVendorProducts(
    vendor?.id,
  );
      ...
      <div className="max-w-6xl mx-auto p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            {loading ? (
              <p className="animate-pulse">Fetching inventory...</p>
            ) : (
                      ...
                      products.map((p) => (
                        <tr key={p.id} className="hover:bg-gray-50 transition">
                          ...
                          <td className="p-4 text-right space-x-3">
                            <button
                              className="text-amber-600  hover:font-semibold p-1 after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 
          ...
          hover:after:w-full relative"
                            ...
                            <button
                              ...
                              className="text-red-500 hover:font-semibold p-1 after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 
          ...
          hover:after:w-full relative"
                      ...
                      <tr>
                        ...
                        >
                          No products found. Start listing items to see them
                          here.
                        </td>
                      </tr>
                    )}
